...
$lang = array_merge(
	$lang, array(
		...
		'INDEX_DISPLAY_AJAX_CHAT_EXPLAIN'	=> 'Wenn Du hier auf "DEAKTIVIERT" stellst, wird nur der Ajax Chat auf der "Indexseite" abgeschaltet.',
		...
		'AJAX_CHAT_POSTS'							=> 'Forum Beitrags-Einstellungen',
		'FORUM_POSTS_AJAX_CHAT'				=> 'Aktiviere "Beiträge im Forum" um neue Beiträge im Chat anzeigen zu lassen',
		'FORUM_POSTS_AJAX_CHAT_TOPIC'		=> 'Aktiviert "Neue Themen im Chat-Anzeigen"',
		'FORUM_POSTS_AJAX_CHAT_REPLY'		=> 'Aktiviert "Thema Antworten im Chat Anzeigen"',
		'FORUM_POSTS_AJAX_CHAT_EDIT'		=> 'Aktiviert "Editierte Beiträge im Chat anzeigen"',
		'FORUM_POSTS_AJAX_CHAT_QUOTE'		=> 'Anzeigen von "zitierten Beiträgen" im Chat aktivieren',
		...
		'AJAX_CHAT_LOCATION'						=> 'Chat-Position',
		'LOCATION_AJAX_CHAT_OVERRIDE'				=> 'Benutzer Chat-Position überschreiben',
		'LOCATION_AJAX_CHAT_OVERRIDE_EXPLAIN'		=> 'Die Aktivierung dieser Einstellung wird die Chat-Positionseinstellung im UCP außer Kraft setzen sowie entfernen dieser Option im UCP.',
		...
		'VIEWFORUM_AJAX_CHAT_OVERRIDE'			=> 'Benutzer Einstellung der Forumsansicht überschreiben',
		'VIEWFORUM_AJAX_CHAT_OVERRIDE_EXPLAIN'	=> 'Durch Aktivieren dieser Einstellung wird die Chat-Forumsansicht-Einstellung im UCP überschrieben sowie die UCP-Option entfernt.',
		'VIEWTOPIC_AJAX_CHAT_OVERRIDE'			=> 'Benutzer Einstellung der Themenansicht überschreiben',
		'VIEWTOPIC_AJAX_CHAT_OVERRIDE_EXPLAIN'	=> 'Durch Aktivieren dieser Einstellung wird die Chat-Themenansicht-Einstellung im UCP überschrieben sowie die UCP-Option entfernt.',
