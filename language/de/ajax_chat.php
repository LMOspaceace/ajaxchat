...
$lang = array_merge(
	$lang, array(
		...
		'CHAT_NEW_POST'			=> 'hat geantwortet auf: <a href="%1$s">%2$s</a>',
		'CHAT_NEW_TOPIC'		=> 'hat ein neues Thema erstellt: <a href="%1$s">%2$s</a>',
		'CHAT_POST_EDIT'		=> 'wurde bearbeitet: <a href="%1$s">%2$s</a>',
