...
//Not uses		'RULES_AJAX_CHAT'							=> 'Insert a simple rule for chat',
		'RULES_AJAX_CHAT_EXPLAIN'					=> 'Здесь вы можете ввести правила чата или ссылку на страницу/сообщение с правилами.',
		...
		'STATUS_IDLE_CHAT'							=> 'Статус «Отошёл»',
		'STATUS_IDLE_CHAT_EXPLAIN'					=> 'Время установки статуса «Отошёл» в секундах. Значение по умолчанию: 300.',
		...
		'REFRESH_IDLE_CHAT'							=> 'Обновление чата у пользователей со статусом «Отошёл»',
		'REFRESH_IDLE_CHAT_EXPLAIN'					=> 'Время обновления чата у пользователей со статусом «Отошёл» в секундах. Значение по умолчанию: 60.',
