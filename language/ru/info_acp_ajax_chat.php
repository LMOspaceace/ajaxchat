...
//Not uses		'RULES_AJAX_CHAT'							=> 'Insert a simple rule for chat',
		...
		'PRUNE_AJAX_CHAT_EXPLAIN'					=> 'Выключите для ручной отчистки сообщений.',
		'PRUNE_KEEP_AJAX_CHAT'						=> 'Количество последних сообщений, которые будут сохранены',
		'PRUNE_NOW'									=> 'Отчистить сейчас',
		'PRUNE_LOG_AJAXCHAT'						=> 'Отчистка сообщений чата',
		'PRUNE_LOG_AJAXCHAT_AUTO'					=> 'Автоматическая отчистка сообщений чата',
		'PRUNE_CHAT_SUCCESS'						=> 'Отчистка сообщений прошла успешно!',
		'CONFIRM_PRUNE_AJAXCHAT'					=> 'Вы уверены, что хотите выполнить отчистку сообщений чата?',
		'TRUNCATE_NOW'								=> 'Полная отчистка',
