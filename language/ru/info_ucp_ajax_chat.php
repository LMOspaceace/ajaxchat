...
$lang = array_merge(
	$lang, array(
		...
		'USER_AJAX_CHAT_POSITION'		=> 'Позиция на главной для отображения чата',
		'USER_AJAX_CHAT_VIEWFORUM'		=> 'Включить чат в форумах',
		'USER_AJAX_CHAT_VIEWTOPIC'		=> 'Включить чат в темах',
		...
		'USER_AJAXCHAT_SETTINGS'		=> 'Настройки Ajax Chat',
		'NO_VIEW_CHAT'					=> 'У вас нет права видеть чат.',
		'AJAX_CHAT_MESSAGES_DOWN'		=> 'Отображать самые новые сообщения в чате вверху или внизу. Также перемещает поля ввода вверх или вниз',
	)
);
